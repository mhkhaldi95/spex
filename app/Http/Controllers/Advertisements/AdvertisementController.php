...
class AdvertisementController extends Controller
{
    ...
    public function index(Request $request){
        if($request->ajax()){
            ...
            $items = Advertisement::query()->with('collections')->orderBy(getColAndDirForOrderBy()['col'], getColAndDirForOrderBy()['dir'])->filter()->paginate($length,'*','*',getPageNumber($length));
    ...
    public function create($id = null)
    {
        ...
        $page_breadcrumbs = [
            ['page' => route('dashboard.index') , 'title' =>'Home','active' => true],
            ['page' => route('advertisements.index') , 'title' =>'Brands','active' => true],
